...
" Add more syntax - Yang Wang - Jul 22, 2010
set autoindent
syn case ignore
syn keyword basicNotesKeywords TODO NOTE 

syn match basicNotesComment "//.*$" 

syn match basicBullitenPoint "^\t*[0-9]*\.\ "
...
hi def link basicNotesKeywords Todo
hi def link basicNotesComment Comment
hi def link basicBullitenPoint Function

hi def link notesTodo Tag
