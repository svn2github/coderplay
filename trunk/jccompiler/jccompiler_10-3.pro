...
; This is the version at the end of Chapter 10. It features multi-
; character keywords and variables, multi-character relational 
; operators and simple read/write.
;
; :Author:
;   ywang
;
...
pro Init
    ...
    if e then !jcNKW = 11 else defsysv, '!jcNKW', 11

    defsysv, '!jcNKW1', exists=e
    if e then !jcNKW1 = 12 else defsysv, '!jcNKW1', 12
